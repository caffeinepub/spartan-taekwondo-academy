...
const WA_LINK = "https://wa.me/919999715086?text=Hello%20I%20want%20to%20join%20Spartan%20Taekwondo%20Academy";
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#111111] shadow-2xl" : "bg-transparent"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
            ...
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-white text-sm md:text-base font-bold tracking-wider uppercase", children: "Spartan" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-white text-xs tracking-widest uppercase opacity-80", children: "Taekwondo Academy" })
                ] })
              ]
            }
          ),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden bg-[#111111] border-t border-white/10 py-4", children: [
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        backgroundImage: "url('/assets/generated/hero-taekwondo.dim_1600x900.jpg')",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(to right, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.75) 40%, rgba(0,0,0,0.25) 70%, rgba(0,0,0,0.1) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 bg-red-brand/90 text-white text-sm font-heading font-semibold uppercase tracking-widest rounded-full mb-6 animate-fade-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 bg-white rounded-full animate-pulse" }),
            "Admissions Open Now"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading text-5xl md:text-7xl lg:text-8xl font-bold uppercase text-white leading-none mb-6 animate-fade-up", children: [
            "Master the Art of",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-red-brand", children: "Taekwondo" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg md:text-xl text-white/85 mb-8 leading-relaxed animate-fade-up", children: "Train with Coach Himanshu Sir at Spartan Taekwondo Academy" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: WA_LINK,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 text-white/50 animate-bounce", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
            "aria-hidden": "true",
            className: "w-6 h-6",
...
function AboutSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 md:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "About Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-[#111] mt-3 mb-6 leading-tight", children: "Spartan Taekwondo Academy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mb-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-700 text-base md:text-lg leading-relaxed mb-4", children: "Welcome to Spartan Taekwondo Academy — a centre of excellence built on the values of discipline, precision, and relentless self-improvement. Founded by Coach Himanshu Sir, our academy has grown into one of the most trusted martial arts training destinations in Delhi." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-700 text-base leading-relaxed mb-4", children: "We believe taekwondo is more than a sport — it is a way of life. Our programs instil physical fitness, mental strength, self-defense capability, and the confidence to conquer any challenge life presents." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-700 text-base leading-relaxed", children: "Whether you are a child taking your first kick or an adult seeking a transformative fitness journey, Spartan Taekwondo Academy welcomes you." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-5 animate-fade-up", children: stats.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-[#111] text-white p-8 rounded-lg text-center card-hover",
        "data-ocid": `about.card.${i + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-4xl md:text-5xl font-bold text-red-brand mb-2", children: stat.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-sm md:text-base text-white/75 uppercase tracking-wide", children: stat.label })
        ]
      },
      stat.id
    )) })
...
function CoachSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "coach", className: "py-20 md:py-28 bg-[#F3F4F6]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "Meet the Mentor" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-[#111] mt-3 leading-tight", children: "Coach Himanshu Sir" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-fade-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-4 bg-red-brand/20 rounded-2xl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-4 -right-4 bg-red-brand text-white px-6 py-3 rounded-lg shadow-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-2xl font-bold", children: "10+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs uppercase tracking-wide", children: "Years Coaching" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-3xl font-bold uppercase text-[#111] mb-1", children: "Coach Himanshu Sir" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-red-brand font-semibold uppercase tracking-wider text-sm mb-4", children: "Head Coach & Founder" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1 bg-red-brand mb-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-700 leading-relaxed mb-4", children: "Coach Himanshu Sir has dedicated over a decade to the art and sport of Taekwondo. A certified black belt and seasoned national-level competitor, he brings an unparalleled depth of technical knowledge, strategic coaching, and genuine passion to every class." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-700 leading-relaxed mb-8", children: "His coaching philosophy centres around holistic development — shaping not just skilled martial artists, but disciplined, confident, and well-rounded individuals who excel both on the mat and in life." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: achievements.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIconRed, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gray-700 text-sm", children: item.text })
        ] }, item.id)) })
      ] })
    ] })
  ] }) });
...
function ProgramsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "programs", className: "py-20 md:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "What We Teach" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-[#111] mt-3 leading-tight", children: "Training Programs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: programs.map((prog, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white border border-gray-100 rounded-xl p-7 shadow-sm card-hover animate-fade-up",
        "data-ocid": `programs.card.${i + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: prog.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block px-3 py-1 bg-red-brand/10 text-red-brand text-xs font-heading font-semibold uppercase tracking-wider rounded-full mb-3", children: prog.age }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-xl font-bold uppercase text-[#111] mb-3 leading-tight", children: prog.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 text-sm leading-relaxed mb-6", children: prog.desc }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: WA_LINK,
...
function OffersSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "offers", className: "py-20 md:py-28 bg-dark-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "Premium Experience" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-white mt-3 leading-tight", children: "What We Offer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: offers.map((offer, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-5 group-hover:scale-110 transition-transform duration-300", children: offer.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-xl font-bold uppercase text-white mb-3 leading-tight group-hover:text-red-brand transition-colors duration-300", children: offer.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/65 text-sm leading-relaxed", children: offer.desc }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 w-8 h-0.5 bg-red-brand group-hover:w-16 transition-all duration-300" })
        ]
      },
      offer.id
    )) })
...
function WhyUsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "why", className: "py-20 md:py-28 bg-[#F3F4F6]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "Our Advantage" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-[#111] mt-3 mb-6 leading-tight", children: "Why Choose Us?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mb-8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-5", children: reasons.map((reason, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-start gap-4",
          "data-ocid": `whyus.item.${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-red-brand rounded-full flex-shrink-0 flex items-center justify-center mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-base font-bold uppercase text-[#111] mb-1", children: reason.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-gray-600 text-sm leading-relaxed", children: reason.desc })
            ] })
          ]
        },
        reason.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-fade-up relative hidden lg:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] rounded-2xl p-10 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-40 h-40 bg-red-brand/20 rounded-full -translate-y-1/2 translate-x-1/2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-32 h-32 bg-blue-brand/20 rounded-full translate-y-1/2 -translate-x-1/2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-7xl font-bold text-red-brand mb-2", children: "₹" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-2xl font-bold uppercase text-white mb-4", children: "Affordable Excellence" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/70 text-sm leading-relaxed mb-6", children: "World-class taekwondo training at fees that are accessible to every family. Invest in your child's future today." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: WA_LINK,
...
function GallerySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "gallery", className: "py-20 md:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "Our Journey" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-[#111] mt-3 leading-tight", children: "Gallery" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-2 gap-4 max-w-3xl mx-auto", children: images.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
  ...
  const testimonials = [
    {
      ...
      stars: 5,
      quote: "My daughter joined Spartan Academy 6 months ago and the transformation is incredible. She's more focused, confident, and disciplined. Coach Himanshu Sir gives personal attention to every child. Best decision we made!"
    },
    {
      id: "rohan",
      name: "Rohan Verma",
      ...
      stars: 5,
      quote: "The level of coaching here is elite. Coach Himanshu Sir doesn't just teach kicks — he builds your character. I've won two district-level competitions since joining. This academy is the real deal."
    },
    {
      id: "meena",
      name: "Meena Gupta",
      ...
      stars: 5,
      quote: "Both my sons train here and we couldn't be happier. The environment is safe, disciplined, and motivating. Coach Himanshu Sir is genuinely invested in every student's growth. Highly recommend!"
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "testimonials", className: "py-20 md:py-28 bg-[#F3F4F6]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "Student Stories" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-[#111] mt-3 leading-tight", children: "Testimonials" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-gray-700 text-sm leading-relaxed mb-6 italic", children: [
            "“",
            t.quote,
            "”"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-base font-bold uppercase text-[#111]", children: t.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-red-brand text-xs uppercase tracking-wider mt-0.5", children: t.role })
          ] })
        ]
      },
      t.id
...
function ContactSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 md:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-red-brand text-sm uppercase tracking-widest font-semibold", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold uppercase text-[#111] mt-3 leading-tight", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-red-brand mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-red-brand rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              "aria-hidden": "true",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-sm font-bold uppercase text-[#111] mb-1", children: "Address" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-body text-gray-600 text-sm leading-relaxed", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-red-brand rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
              "aria-hidden": "true",
              className: "w-6 h-6 text-white",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-sm font-bold uppercase text-[#111] mb-1", children: "Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "tel:9999715086",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-[#E1306C] rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
              "aria-hidden": "true",
              className: "w-6 h-6 text-white",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-sm font-bold uppercase text-[#111] mb-1", children: "Instagram" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                "data-ocid": "contact.link",
                children: "@spartan_taekwondo_a_cademy"
              }
            )
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-fade-up rounded-xl overflow-hidden shadow-lg h-80 lg:h-auto min-h-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "iframe",
        {
...
function FinalCTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-20 md:py-28 bg-dark-brand relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-96 h-96 bg-red-brand/10 rounded-full translate-x-1/2 -translate-y-1/2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl mx-auto px-4 text-center animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 border border-red-brand/50 text-red-brand text-xs font-heading font-semibold uppercase tracking-widest rounded-full mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 bg-red-brand rounded-full animate-pulse" }),
        "Admissions Open"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-heading text-4xl md:text-6xl font-bold uppercase text-white leading-tight mb-6", children: [
        "Start Your Taekwondo",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-red-brand", children: "Journey Today" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/70 text-lg leading-relaxed mb-8", children: "Limited seats available. Join Spartan Taekwondo Academy and begin your transformation under the guidance of Coach Himanshu Sir." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: WA_LINK,
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#0A0A0A] border-t border-white/10 pt-14 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-white text-base font-bold tracking-wider uppercase", children: "Spartan" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-white/60 text-xs tracking-widest uppercase", children: "Taekwondo Academy" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-white/55 text-sm leading-relaxed", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-white text-sm font-bold uppercase tracking-wider mb-4", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-white text-sm font-bold uppercase tracking-wider mb-4", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-body text-white/55 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            "Near Modern Savitri Public School,",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Asthal Mandir Road, New Delhi"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-body text-white/40 text-xs text-center md:text-left", children: [
        "© ",
        currentYear,
        " Spartan Taekwondo Academy. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-body text-white/40 text-xs text-center", children: [
        "Built with ❤️ using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
...
function FloatingWhatsApp() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "a",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppIcon, { size: 28 })
    }
  );
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-body", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CoachSection, {}),
